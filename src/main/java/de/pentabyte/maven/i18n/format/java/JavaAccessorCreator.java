...
public class JavaAccessorCreator {
	...
	public JavaAccessorCreator(Table table, String keySeparator) {
		this.table = table;
	 ...
	 * 
	 */
	public void write(JavaAccessor accessor) throws IOException {
		File accessorFile = new File(accessor.getDirectory(),
		...
		classWriter.writeLine("private static String BASE_NAME = \"" + accessor.getResourceBundleBaseName() + "\";");
